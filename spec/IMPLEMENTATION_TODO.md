...
### [ ] T18. Design and implement the Syntax Assistant query command first slice
...
- UAT-SH-006
- UAT-SH-015
- NFR-QUERY-001 measurement notes for exact lookup, keyword search, fuzzy search and relationship
  search
- `git diff --check`
