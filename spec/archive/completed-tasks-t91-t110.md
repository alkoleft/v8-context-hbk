# Completed Implementation Tasks T91-T110
...
are intentionally omitted from this archive. Durable cleanup, resolver, book-content export,
documentation-site generator and web-app conclusions live in `../acceptance/baseline.md`,
`../requirements/functional.md`, `../requirements/non-functional.md`,
`../implementation/components.md`, `../implementation/documentation-site.md`,
`../implementation/syntax-helper-query-cli.md`, `../implementation/syntax-bsl-provider-plan.md`,
`../implementation/solution-context-resolve.md` and `../decisions/ADR-0010-documentation-site-generator-and-web-app.md`.
...
## T109. Materialize Markdown target anchors for source HTML heading fragments
...
## T108. Convert Courier query blockquotes to `sdbl` code blocks
...
## T107. Preserve fragment anchors in Markdown internal links
...
## T106. Mark exported BSL code fences with the `bsl` language
...
## T105. Convert single-cell Courier code tables to Markdown code blocks
...
## T104. Preserve TOC titles for shared content-node placeholder pages
...
## T110. Specify documentation site generator and web app split
...
- Single-book Markdown/TOC export is complete enough for readable files, but it does not define
  generated data artifacts or a web application for the full documentation corpus.
- General-purpose static-site generators such as MkDocs and Docusaurus are not a reliable first
  implementation path for the full HBK documentation corpus because they attempt page-per-route
  build work over a very large page set.
- The project needs a replacement for `/home/alko/develop/open-source/hbk-reader` in the web/view
  responsibility: global merged TOC, static page viewing and lazy navigation over generated
  artifacts.

Scope:

- Add the ADR and specification package for a documentation-site generator and separate web app.
- Define the first global TOC merge and generated data artifact contracts.
- Add UAT cases for site data generation and web-app serving/loading.
- Add implementation tasks for the first generator and web app slices.
- Do not implement Rust generator code, frontend/web-app code, search, Syntax Assistant API,
  MkDocs/Docusaurus adapters or README user-facing command documentation in this task.
...
- Added ADR-0010 selecting a generator utility plus separate web app over MkDocs/Docusaurus for the
  full HBK corpus.
- Added `spec/implementation/documentation-site.md` with artifact layout, manifest/TOC/page-data
  contracts, global TOC merge rules and first generator/web-app implementation slices.
- Added UC-HBK-004, FR-HBK-005, NFR-SITE-001, UAT-HBK-014 and UAT-HBK-015.
- Updated component boundaries with the planned `hbk-doc-site` generator crate, separate web app
  and CLI command direction.
