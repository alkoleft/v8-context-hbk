...
список не входит. Это минимальная структура, которую AV5 должен проверить в
составе X1, но AV4 не подтвердил её как быструю относительно H0/C0 на
median/p90/p99/max type scope. Тем самым «подтверждённый компонент» и
«проверяемая часть композиции» остаются явно разными статусами. X1 целиком до
завершения parity и замеров не считается подтверждённой гипотезой.
