...
readonly RESULTS_ROOT="${HBK_BENCH_RESULTS_ROOT:-${REPO_ROOT}/target/hbk-zero-copy-experiment}"
readonly RAW_RESULTS="${HBK_BENCH_RAW_RESULTS:-${RESULTS_ROOT}/results/raw-v1.jsonl}"
readonly LOG_DIR="${RESULTS_ROOT}/logs"
readonly RUN_DIR="${RESULTS_ROOT}/runs"
readonly PREPARED_CACHE="${HBK_BENCH_PREPARED_CACHE:-${RESULTS_ROOT}/prepared/current-cache.bin}"
readonly SQLITE_PATH="${HBK_BENCH_SQLITE_PATH:-${REPO_ROOT}/target/snapshot-materialization/shcntx_ru.schema16.release.sqlite}"
readonly HBK_PATH="${HBK_BENCH_HBK_PATH:-/opt/1cv8/x86_64/8.5.1.1150/shcntx_ru.hbk}"
readonly SQLITE_SHA256="${HBK_BENCH_SQLITE_SHA256:-cc9b2b8aaf31f64c880b92cc3a02fd3166541f10f8d209faf8c7a7c22cac0d55}"
readonly HBK_SHA256="${HBK_BENCH_HBK_SHA256:-b8bc0d3a1ee8d00e2f113a800339731304428cc35ae395e5094a8b022773f8ed}"
readonly DATASET_ID="${HBK_BENCH_DATASET_ID:-shcntx_ru-8.5.1.1150-schema16-extraction11}"
readonly PLATFORM_VERSION="${HBK_BENCH_PLATFORM_VERSION:-8.5.1.1150}"
readonly PROVIDER_SCHEMA_VERSION="${HBK_BENCH_PROVIDER_SCHEMA_VERSION:-16}"
readonly EXTRACTION_SCHEMA_VERSION="${HBK_BENCH_EXTRACTION_SCHEMA_VERSION:-11}"
